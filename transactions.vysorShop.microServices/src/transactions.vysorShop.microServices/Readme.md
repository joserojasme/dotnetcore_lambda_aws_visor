...
Execute unit tests
```
    cd "transactions.vysorShop.microServices/test/transactions.vysorShop.microServices.Tests"
    dotnet test
```

Deploy application
```
    cd "transactions.vysorShop.microServices/src/transactions.vysorShop.microServices"
