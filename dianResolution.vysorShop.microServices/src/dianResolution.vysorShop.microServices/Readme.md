...
Execute unit tests
```
    cd "dianResolution.vysorShop.microServices/test/dianResolution.vysorShop.microServices.Tests"
    dotnet test
```

Deploy application
```
    cd "dianResolution.vysorShop.microServices/src/dianResolution.vysorShop.microServices"
