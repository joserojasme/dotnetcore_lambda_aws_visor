...
namespace dianResolution.vysorShop.microServices.Models
{
    public partial class Context : DbContext
    {
        ...
        public virtual DbSet<ResolucionDian> ResolucionDian { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdresolucionDian);

                entity.ToTable("resolucion_dian");

                entity.HasIndex(e => e.NumeroResolucion)
                    .HasName("numeroResolucion_UNIQUE")
                    .IsUnique();

                entity.Property(e => e.IdresolucionDian)
                    .HasColumnName("idresolucion_dian")
                    .HasColumnType("int(11)")
                    .ValueGeneratedNever();
                ...
                entity.Property(e => e.NumActual)
                    .HasColumnName("numActual")
                    .HasColumnType("int(11)");
