...
Execute unit tests
```
    cd "pricelist.vysorShop.microServices/test/pricelist.vysorShop.microServices.Tests"
    dotnet test
```

Deploy application
```
    cd "pricelist.vysorShop.microServices/src/pricelist.vysorShop.microServices"
