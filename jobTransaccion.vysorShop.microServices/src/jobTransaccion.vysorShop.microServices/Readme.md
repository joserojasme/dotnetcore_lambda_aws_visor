...
Execute unit tests
```
    cd "jobTransaccion.vysorShop.microServices/test/jobTransaccion.vysorShop.microServices.Tests"
    dotnet test
```

Deploy application
```
    cd "jobTransaccion.vysorShop.microServices/src/jobTransaccion.vysorShop.microServices"
